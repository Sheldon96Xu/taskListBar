...
int blockColor = #f0e7e7;
int blockHighlight = #ffffff;
...
void mouseClicked() {
  ...
  else if (zoomInd>=0 && mouseX>M2W*width && mouseX<M2W*width+D2W*width &&
           mouseY>height*reserved+zoomInd*decHeight+F2BHr*incHeight && 
           mouseY<height*reserved+zoomInd*decHeight+F2BHr*incHeight+D2W*width) {
